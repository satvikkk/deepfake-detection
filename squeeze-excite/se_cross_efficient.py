...
# ImageEmbedder definition with SE block
class ImageEmbedder(nn.Module):
    def __init__(
        ...
        *,
        ...
        # Define patch embedding layer with SE block
        self.to_patch_embedding = nn.Sequential(
            Rearrange('b c (h p1) (w p2) -> b (h w) (p1 p2 c)', p1=patch_size, p2=patch_size),
            nn.Linear(patch_dim, dim),
            SEBlock(dim)  # Add SE block after patch embedding
        )
    ...
    def forward(self, img):
        ...
        # Convert features to patch embeddings with SE block
